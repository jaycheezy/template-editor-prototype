...
export const PHASES: PhaseMeta[] = [
  ...
  },
  {
    ...
    short: 'Author',
    description: 'Add, rename, resize, recolor, and delete text, image, and vector layers.',
    epic: 'ADSCM-1386',
    group: 'epic',
    requires: [],
  },
  ...
  },
  {
    ...
    label: 'Groups',
    short: 'Groups',
    description: 'Create / ungroup, rename, nested layer tree, enter-group editing and group transforms.',
    epic: 'ADSCM-1392',
    group: 'epic',
    requires: [],
  },
